...
- robustness : capacity of an analytic pipeline or conclusion to remain consistent when exposed to variation
- sources of variation include missing or imbalanced data, uncertainty in labels, alternative feature extraction strategies
- robustness can be evaluated using fundamental data visualization strategies across the full data science lifecycle
